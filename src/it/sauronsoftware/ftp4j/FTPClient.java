...
public class FTPClient {
     ...
     * @since 1.4
     */
    private static final int SECURITY_FTP = 0;
     ...
     */
    private static final int TYPE_TEXTUAL = 1;
     ...
     * @since 1.5
     */
    private static final int MLSD_IF_SUPPORTED = 0;
     ...
     * @since 1.5
     */
    private static final int MLSD_ALWAYS = 1;
     ...
     * @since 1.5
     */
    private static final int MLSD_NEVER = 2;
     ...
     */
    private final ArrayList listParsers = new ArrayList();
     ...
     * should be one of {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_AUTO},
     * {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_TEXTUAL} and {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_BINARY}
     ...
     * {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_IF_SUPPORTED}, {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_ALWAYS} and
     * {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_NEVER} constants. Default value is
     * MLSD_IF_SUPPORTED.
     */
     ...
     * @see it.sauronsoftware.ftp4j.connectors.DirectConnector
     */
     ...
     * @throws java.io.IOException If the SSL negotiation fails.
     */
     ...
     * constants. Default value is TYPE_AUTO.
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_TEXTUAL} means that the data sent or received is
     * treated as textual information. This implies charset conversion during
     * the transfer.
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_BINARY} means that the data sent or received is
     * treated as a binary stream. The data is taken "as is", without any
     * charset conversion.
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_AUTO} lets the client pick between textual and
     ...
     * instance of {@link it.sauronsoftware.ftp4j.extrecognizers.DefaultTextualExtensionRecognizer}.
     *
     * @param type The type.
     ...
     * @see it.sauronsoftware.ftp4j.extrecognizers.DefaultTextualExtensionRecognizer
     */
     ...
     *         constants {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_AUTO},
     *         {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_BINARY} and {@link it.sauronsoftware.ftp4j.FTPClient#TYPE_TEXTUAL}.
     */
    public int getType() {
        synchronized (lock) {
            return type;
     ...
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_IF_SUPPORTED} means that the client should use the
     * MLSD command only if it is explicitly supported by the server.
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_ALWAYS} means that the client should use always the
     * MLSD command, also if the MLSD command is not explicitly supported by the
     * server
     * <p/>
     * {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_NEVER} means that the client should use always only
     ...
     *         to the constants {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_IF_SUPPORTED},
     *         {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_ALWAYS} and {@link it.sauronsoftware.ftp4j.FTPClient#MLSD_NEVER}.
     * @since 1.5
     */
     ...
     * {@link it.sauronsoftware.ftp4j.FTPClient#setCompressionEnabled(boolean)} .
     * <p/>
     ...
     * @see it.sauronsoftware.ftp4j.FTPClient#isCompressionEnabled()
     * @since 1.5
     */
     ...
     * {@link it.sauronsoftware.ftp4j.FTPClient#isCompressionSupported()}) returned value are
     * <em>true</em>.
     * <p/>
     ...
     *                           feature.
     * @see it.sauronsoftware.ftp4j.FTPClient#isCompressionSupported()
     * @since 1.5
     */
     ...
     * this method and {@link it.sauronsoftware.ftp4j.FTPClient#isCompressionSupported()} return
     * <em>true</em>.
     *
     ...
     * <p/>
     * Default one is {@link it.sauronsoftware.ftp4j.extrecognizers.DefaultTextualExtensionRecognizer}.
     *
     ...
     * <p/>
     * The default one is {@link it.sauronsoftware.ftp4j.extrecognizers.DefaultTextualExtensionRecognizer}.
     * <p/>
     * You can plug your own by implementing the
     * {@link it.sauronsoftware.ftp4j.FTPTextualExtensionRecognizer} interface. For your convenience the
     * ftp4j gives you another FTPTextualExtensionRecognizer implementation,
     * which is {@link it.sauronsoftware.ftp4j.extrecognizers.ParametricTextualExtensionRecognizer}.
     *
     * @param textualExtensionRecognizer The textual extension recognizer used by the client.
     * @see it.sauronsoftware.ftp4j.extrecognizers.DefaultTextualExtensionRecognizer
     * @see it.sauronsoftware.ftp4j.extrecognizers.ParametricTextualExtensionRecognizer
     */
    ...
    public boolean isConnected() {
        new AsyncNoop().execute();
        synchronized (lock) {
            return connected;
        }
    }

    private class AsyncNoop extends AsyncTask<Void, Void, Void> {
    ...
    /**
     * This method returns a list with all the {@link it.sauronsoftware.ftp4j.FTPCommunicationListener}
     * used by the client.
     *
    ...
    /**
     * This method adds a {@link it.sauronsoftware.ftp4j.FTPListParser} to the object.
     *
    ...
    /**
     * This method removes a {@link it.sauronsoftware.ftp4j.FTPListParser} previously added to the
     * object.
     *
    ...
    /**
     * This method returns a list with all the {@link it.sauronsoftware.ftp4j.FTPListParser} used by the
     * client.
     *
     ...
     * {@link it.sauronsoftware.ftp4j.FTPClient#setSecurity(int)}).
     *
     ...
     * @throws java.io.IOException   If an I/O occurs.
        ...
        synchronized (lock) {
            ...
            try {
                ...
                for (Object communicationListener : communicationListeners) {
                    communication.addCommunicationListener((FTPCommunicationListener) communicationListener);
                }
                // Welcome message.
     ...
     * connect() method will exit with an {@link java.io.IOException}.
     *
     * @since 1.7
     */
     ...
     * @throws java.io.IOException   If an I/O occurs (can be thrown only if sendQuitCommand is
     *                               true).
     * @throws it.sauronsoftware.ftp4j.FTPIllegalReplyException
     ...
     *
     * @see it.sauronsoftware.ftp4j.FTPClient#disconnect(boolean)
     */
     ...
     *                               If login fails.
     */
    public boolean noop() throws IllegalStateException, IOException,
            FTPIllegalReplyException, FTPException {
        boolean isSuccess;
        synchronized (lock) {
            // Is this client connected?
     ...
     *                               sent by the server.
     * @see it.sauronsoftware.ftp4j.FTPListParser
     * @see it.sauronsoftware.ftp4j.FTPClient#addListParser(it.sauronsoftware.ftp4j.FTPListParser)
     * @see it.sauronsoftware.ftp4j.FTPClient#getListParsers()
     * @see it.sauronsoftware.ftp4j.FTPClient#abortCurrentDataTransfer(boolean)
     * @see it.sauronsoftware.ftp4j.FTPClient#listNames()
     * @since 1.2
     */
    FTPFile[] list(String fileSpec, boolean showHiddenFiles) throws IllegalStateException,
            IOException, FTPIllegalReplyException, FTPException,
     ...
     * @see it.sauronsoftware.ftp4j.FTPClient#listNames()
     */
    public FTPFile[] list(boolean showHiddenFiles) throws IllegalStateException, IOException, FTPIllegalReplyException, FTPException,
            FTPDataTransferException, FTPAbortedException, FTPListParseException {
        return list(null, showHiddenFiles);
    }
     ...
     *                               sent by the server.
     * @see it.sauronsoftware.ftp4j.FTPClient#abortCurrentDataTransfer(boolean)
     * @see it.sauronsoftware.ftp4j.FTPClient#list()
     */
     ...
     * @throws IllegalStateException         If the client is not connected or not authenticated.
     * @throws java.io.FileNotFoundException If the supplied file cannot be found.
     * @throws java.io.IOException           If an I/O error occurs.
     * @throws it.sauronsoftware.ftp4j.FTPIllegalReplyException
     *                                       If the server replies in an illegal way.
     * @throws it.sauronsoftware.ftp4j.FTPException
     ...
     *                  {@link it.sauronsoftware.ftp4j.FTPClient#isResumeSupported()} to check if the server
     ...
     * @see it.sauronsoftware.ftp4j.FTPClient#abortCurrentDataTransfer(boolean)
     */
    void upload(File file, long restartAt,
     ...
     * @since 1.6
     */
    void append(File file, FTPDataTransferListener listener)
            throws IllegalStateException, IOException,
            FTPIllegalReplyException, FTPException, FTPDataTransferException,
            FTPAbortedException {
        if (!file.exists()) {
     ...
     * @since 1.6
     */
    void append(String fileName, InputStream inputStream,
     ...
     * @see it.sauronsoftware.ftp4j.FTPClient#abortCurrentDataTransfer(boolean)
     */
    void download(String remoteFileName, File localFile, long restartAt,
                  FTPDataTransferListener listener) throws IllegalStateException,
            IOException, FTPIllegalReplyException,
            FTPException, FTPDataTransferException, FTPAbortedException {
     ...
     * @throws java.io.IOException If the ABOR command cannot be sent due to any I/O error. This
     *                             could happen only if force is false.
     * @throws it.sauronsoftware.ftp4j.FTPIllegalReplyException
     *                             If the server reply to the ABOR command is illegal. This
     *                             could happen only if force is false.
     */
    public void abortCurrentDataTransfer(boolean sendAborCommand) throws IOException {
        synchronized (abortLock) {
     ...
     * @throws java.io.IOException If an unexpected I/O error occurs while trying to resolve the
     *                             local address.
     */
     ...
     * the {@link it.sauronsoftware.ftp4j.FTPKeys#ACTIVE_DT_HOST_ADDRESS}, it returns it as a 4 elements
