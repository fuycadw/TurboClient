...
public class FTPProxyConnector extends FTPConnector {
     ...
     * <p/>
     * {@link it.sauronsoftware.ftp4j.connectors.FTPProxyConnector#STYLE_SITE_COMMAND} - Requires the connection to
     * the remote host through a SITE command after proxy authentication.
     * <p/>
     * {@link it.sauronsoftware.ftp4j.connectors.FTPProxyConnector#STYLE_OPEN_COMMAND} - Requires the connection to
     * the remote host through a OPEN command without proxy authentication.
     * <p/>
     * Default value for the style is STYLE_SITE_COMMAND.
     *
     * @param style The style.
     * @see it.sauronsoftware.ftp4j.connectors.FTPProxyConnector#STYLE_SITE_COMMAND
     * @see it.sauronsoftware.ftp4j.connectors.FTPProxyConnector#STYLE_OPEN_COMMAND
     */
