...
public abstract class FTPConnector {
     ...
     *
     * @see it.sauronsoftware.ftp4j.FTPConnector#setUseSuggestedAddressForDataConnections(boolean)
     * @since 1.7.1
     */
     ...
     * {@link it.sauronsoftware.ftp4j.FTPClient#connect(String)} and
     * {@link it.sauronsoftware.ftp4j.FTPClient#connect(String, int)} methods). In this case, the
     ...
     * {@link it.sauronsoftware.ftp4j.FTPConnector#connectionTimeout}, {@link it.sauronsoftware.ftp4j.FTPConnector#readTimeout}
     * and {@link it.sauronsoftware.ftp4j.FTPConnector#closeTimeout}.
     * <p/>
     ...
     * connection calling {@link it.sauronsoftware.ftp4j.FTPClient#abortCurrentConnectionAttempt()}.
     *
